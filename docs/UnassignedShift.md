...
**customFields** | **Array&lt;{ [key: string]: any; }&gt;** | Custom fields for the unassigned shift | [optional] [default to undefined]

## Example

```typescript
import { UnassignedShift } from 'rippling-typescript-sdk';

const instance: UnassignedShift = {
    id,
    createdAt,
    updatedAt,
    scheduleId,
