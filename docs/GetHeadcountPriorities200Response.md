...
**name** | **string** | Display name of the headcount priority | [optional] [default to undefined]

## Example

```typescript
import { GetHeadcountPriorities200Response } from 'rippling-typescript-sdk';

const instance: GetHeadcountPriorities200Response = {
    meta,
    id,
    createdAt,
    updatedAt,
