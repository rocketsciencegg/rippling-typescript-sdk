...
------------ | ------------- | ------------- | -------------
**type** | [**ContactType**](ContactType.md) | The classification of the address. | [optional] [default to undefined]
**formatted** | **string** | The formatted mailing address. | [optional] [default to undefined]
...
**country** | [**CountryCode**](CountryCode.md) | The country component, pursuant to SCIM RFC 7643 4.1.2. | [optional] [default to undefined]

## Example

```typescript
import { UserAddress } from 'rippling-typescript-sdk';
