...
**customFields** | **Array&lt;{ [key: string]: object; }&gt;** | Custom fields for the shift assignment | [optional] [default to undefined]

## Example

```typescript
import { GetShiftassignments200Response } from 'rippling-typescript-sdk';

const instance: GetShiftassignments200Response = {
    meta,
    id,
    createdAt,
    updatedAt,
