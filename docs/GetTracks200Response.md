...
**name** | **string** | The name of the track. Must be unique within the company or organization. | [default to undefined]

## Example

```typescript
import { GetTracks200Response } from 'rippling-typescript-sdk';

const instance: GetTracks200Response = {
    meta,
    id,
    createdAt,
    updatedAt,
